          ...
          <div className="columns-1 gap-4 sm:columns-2 lg:columns-3">
            {portfolioItems.map((item, i) => (
              <AnimateIn key={item.id} delay={i * 0.08} className="mb-4 break-inside-avoid">
                <div className="group relative overflow-hidden rounded-2xl border border-silk-gold/20 transition duration-500 hover:border-silk-gold/50 hover:shadow-xl hover:shadow-silk-gold/10">
                  <Image
                    src={item.image}
                  ...
                  <div className="absolute inset-0 flex items-end bg-gradient-to-t from-silk-indigo/85 to-transparent p-4 opacity-0 transition duration-500 group-hover:opacity-100">
                    <p className="silk-headline text-lg text-white">
